...
Angular-Projekte verwenden die neueste stabile, aktiv unterstützte Angular-Major-Version, sofern `Repository.md` nichts anderes festlegt. Vor Scaffold, Major Upgrade oder Toolchain-Wechsel werden `https://angular.dev/reference/releases` und `https://angular.dev/reference/versions` geprüft.
