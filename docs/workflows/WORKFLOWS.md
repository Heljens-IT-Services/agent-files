...
| `commit-push` | Commit Push | `/cp` | Fertige lokale Aenderungen zusammenhaengend committet und gepusht werden sollen. | [commit-push.md](https://heljens-it-services.github.io/agent-files/workflows/commit-push.md) | Aenderungen committen und pushen. |
| `feature-finish` | Feature Finish | `/finish` | Ein freigegebener Arbeitsbranch sicher committed, geprueft, gemergt und abgeschlossen werden soll. | [feature-finish.md](https://heljens-it-services.github.io/agent-files/workflows/feature-finish.md) | Arbeitsbranch abschliessen. |
...
| `issue-to-sub-issues` | Issue To Sub Issues | `/sub-issues <issue-nummer>` | Ein grosses GitHub-Issue in mehrere Sub-Issues geschnitten und als Child-Issues angelegt werden soll. | [issue-to-sub-issues.md](https://heljens-it-services.github.io/agent-files/workflows/issue-to-sub-issues.md) | Issue aufteilen. |
...
| `release` | Release | `/release` | Der freigegebene Stand von `develop` nach `main` veroeffentlicht werden soll. | [release.md](https://heljens-it-services.github.io/agent-files/workflows/release.md) | Develop-Stand nach Main freigeben. |
