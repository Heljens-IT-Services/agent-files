...
Diese Datei gilt für TypeScript. Zugehörige allgemeine und technologiespezifische Regeldateien werden über [ROLES.md](https://heljens-it-services.github.io/agent-files/roles/ROLES.md) aufgelöst.
