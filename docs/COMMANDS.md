...
| Skills | `/skills list`, `/skills show <skill-id>`, `/skills run <skill-id> [<argument> ...]` | Listet, beschreibt oder waehlt einen Skill aus. Zusaetzliche Argumente sind nur zulaessig, wenn der Skill sie dokumentiert. |
