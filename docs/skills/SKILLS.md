...
| `github-repository-basiskonfiguration` | GitHub Repository-Basiskonfiguration | - | Die standardisierte GitHub-Basiskonfiguration eines Repositorys geprüft oder ergänzt werden soll. | [github_repository-basiskonfiguration.md](https://heljens-it-services.github.io/agent-files/skills/github_repository-basiskonfiguration.md) | GitHub-Repository-Basis pflegen. |
