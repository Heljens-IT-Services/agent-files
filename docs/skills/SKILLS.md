...
| `code-refactoring` | Code Refactoring | `/refactor` | Struktur ohne beabsichtigte Verhaltensaenderung verbessert werden soll. | [code_refactoring.md](https://heljens-it-services.github.io/agent-files/skills/code_refactoring.md) | Code strukturieren. |
| `code-testen` | Code Testen | `/testing`<br>`/testing --mode <modus>` | Eine Aenderung mit Build-, Test-, E2E- oder manuellen Pruefschritten verifiziert werden soll. | [code_testen.md](https://heljens-it-services.github.io/agent-files/skills/code_testen.md) | Aenderungen gezielt oder kontextbezogen verifizieren. |
...
| `github-commit` | GitHub Commit | `/commit` | Fertige lokale Aenderungen logisch geschnitten und ohne Push committet werden sollen. | [github_commit.md](https://heljens-it-services.github.io/agent-files/skills/github_commit.md) | Lokale Commits erstellen. |
| `github-commit-history-lesen` | GitHub Commit History Lesen | - | Commits und gemergte Pull Requests eines Repositorys fuer einen Zeitraum vollstaendig gelesen werden sollen. | [github_commit-history-lesen.md](https://heljens-it-services.github.io/agent-files/skills/github_commit-history-lesen.md) | Aenderungshistorie erfassen. |
