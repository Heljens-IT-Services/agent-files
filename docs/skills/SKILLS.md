...
| `code-testen` | Code Testen | `/testing` | Eine Aenderung mit Build-, Test- oder manuellen Pruefschritten verifiziert werden soll. | [code_testen.md](https://heljens-it-services.github.io/agent-files/skills/code_testen.md) | Aenderungen verifizieren. |
