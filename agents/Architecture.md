...
Diese Datei definiert die technologieübergreifenden Architektur-, Clean-Code- und Qualitätsregeln dieses Repositories. Technologiespezifische Details stehen in den passenden `agents/Architecture.*.md`-Dateien. Projektspezifische Fakten, Pfade, Fachregeln und Kommandos stehen in `agents/Repository.md`.

## Architekturdateien

| Datei | Gilt für |
|---|---|
| `agents/Architecture.md` | Technologieübergreifende Architektur-, Clean-Code- und Qualitätsregeln. |
| `agents/Architecture.Angular.md` | Angular-Anwendungen mit klarer Trennung von View, State, lokaler Persistenz, Worker und Web API. |
| `agents/Architecture.NETConsole.md` | .NET-10-Konsolenanwendungen mit Host, DI, SOLID, Konfiguration, Logging und Tests. |
| `agents/Repository.md` | Projektspezifische Informationen, Fachregeln, Pfade und Kommandos. |
...
- `agents/Repository.md` beschreibt das konkrete Projekt und wird bei relevanten Struktur- oder Fachänderungen gepflegt.
